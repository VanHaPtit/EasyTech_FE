# task-be-05_API_gui_email_xac_nhan

## Mục đích
Xác định phạm vi backend cho task 'API gui email xac nhan' trong US-26 Nop CV, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
