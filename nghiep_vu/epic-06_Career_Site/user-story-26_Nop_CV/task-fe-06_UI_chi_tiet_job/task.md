# task-fe-06_UI_chi_tiet_job

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-06 UI chi tiet job.
...
## Mục đích
Xây dựng screen/component phục vụ US-26 - Nộp CV, tập trung vào hành vi người dùng và trạng thái UI.

## Screen/Component
- Component chính: Job Detail.
