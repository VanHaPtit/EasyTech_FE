# task-fe-03_UI_cai_dat_mau_email

## Mục đích
Xác định phạm vi frontend cho task 'UI cai dat mau email' trong US-29 Email Templates, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
## Screen/Component
- Component chính: Settings Templates.
