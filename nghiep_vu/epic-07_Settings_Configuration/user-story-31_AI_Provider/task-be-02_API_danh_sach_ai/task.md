# task-be-02_API_danh_sach_ai

## Mục đích
Xác định phạm vi backend cho task 'API danh sach ai' trong US-31 AI Provider, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
## Response
- Thành công: BaseResponse(status = 1, message, data); Danh sách provider khả dụng và provider đang active.
