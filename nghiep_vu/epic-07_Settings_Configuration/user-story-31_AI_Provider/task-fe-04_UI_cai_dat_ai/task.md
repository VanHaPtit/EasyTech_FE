# task-fe-04_UI_cai_dat_ai

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-04 UI cai dat ai.
...
## Mục đích
Xây dựng screen/component phục vụ user-story-22 AI Provider, tập trung vào hành vi người dùng và trạng thái UI.

## Screen/Component
- Component chính: AI Provider.
