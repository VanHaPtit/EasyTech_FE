# task-fe-01_UI_phan_quyen_hr

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-01 UI phan quyen hr.
...
## Mục đích
Xây dựng screen/component phục vụ US-32 - HR quản lý phân quyền, tập trung vào hành vi người dùng và trạng thái UI.

## Screen/Component
- Component chính: UI HR RBAC.
