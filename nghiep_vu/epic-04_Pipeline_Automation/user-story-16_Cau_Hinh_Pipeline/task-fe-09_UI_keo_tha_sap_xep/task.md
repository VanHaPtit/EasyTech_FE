# task-fe-09_UI_keo_tha_sap_xep

## Mục đích
Xác định phạm vi frontend cho task 'UI keo tha sap xep' trong US-16 Cau Hinh Pipeline, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
- `GET /api/v1/jobs/{jobId}/rounds`, `PUT /api/v1/jobs/{jobId}/rounds/reorder`.
