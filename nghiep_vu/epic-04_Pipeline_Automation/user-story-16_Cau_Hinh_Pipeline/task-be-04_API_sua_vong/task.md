# task-be-04_API_sua_vong

## Mục đích
Xác định phạm vi backend cho task 'API sua vong' trong US-16 Cau Hinh Pipeline, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
## Response
- Thành công: BaseResponse(status = 1, message, data); Round sau khi cập nhật.
