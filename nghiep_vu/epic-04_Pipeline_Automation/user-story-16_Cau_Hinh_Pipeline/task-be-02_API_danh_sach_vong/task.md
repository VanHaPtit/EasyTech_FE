# task-be-02_API_danh_sach_vong

## Mục đích
Xác định phạm vi backend cho task 'API danh sach vong' trong US-16 Cau Hinh Pipeline, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
