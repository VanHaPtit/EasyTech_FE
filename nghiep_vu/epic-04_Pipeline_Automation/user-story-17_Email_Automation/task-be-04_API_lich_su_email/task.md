# task-be-04_API_lich_su_email

## Mục đích
Xác định phạm vi backend cho task 'API lich su email' trong US-17 Email Automation, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
