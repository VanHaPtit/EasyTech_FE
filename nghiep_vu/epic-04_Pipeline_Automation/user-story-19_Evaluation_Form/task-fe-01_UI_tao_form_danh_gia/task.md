# task-fe-01_UI_tao_form_danh_gia

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-01 UI tao form danh gia.

## Mô tả chức năng chi tiết
Đây là module đảm nhận vai trò thực thi chức năng đã định nghĩa, đảm bảo luồng nghiệp vụ hoạt động chính xác.

# Task FE: Evaluation Form Builder

## Mục đích
Xây dựng screen/component phục vụ user-story-26 Evaluation Form, tập trung vào hành vi người dùng và trạng thái UI.

## Screen/Component
- Component chính: Evaluation Form Builder.
