# task-fe-07_UI_nut_xu_ly_cong_ty

## Mục đích
Xác định phạm vi frontend cho task 'UI nut xu ly cong ty' trong US-06 Admin Duyet Doanh Nghiep, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
## Screen/Component
- Component chính: Action Buttons.
