# task-fe-06_UI_dashboard_admin

## Mục đích
Xác định phạm vi frontend cho task 'UI dashboard admin' trong US-06 Admin Duyet Doanh Nghiep, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
