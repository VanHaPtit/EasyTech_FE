# task-fe-01_UI_xem_log_he_thong

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-01 UI xem log he thong.
...
## Mục đích
Xây dựng screen/component phục vụ US-08 - Admin xem Audit Logs, tập trung vào hành vi người dùng và trạng thái UI.
