# task-fe-01_UI_quan_ly_tai_khoan

## Mục đích
Xác định phạm vi frontend cho task 'UI quan ly tai khoan' trong US-09 Admin Users Management, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
