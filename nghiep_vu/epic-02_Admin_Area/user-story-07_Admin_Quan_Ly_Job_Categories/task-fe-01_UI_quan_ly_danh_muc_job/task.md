# task-fe-01_UI_quan_ly_danh_muc_job

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-01 UI quan ly danh muc job.
...
## Mục đích
Xây dựng screen/component phục vụ US-07 - Admin quản lý Job Categories, tập trung vào hành vi người dùng và trạng thái UI.
