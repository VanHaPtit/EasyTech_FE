# task-fe-05_UI_form_dang_nhap

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-05 UI form dang nhap.

## Mô tả chức năng chi tiết
Code giao diện form đăng nhập theo thiết kế UI/UX. Áp dụng React Hook Form kết hợp Yup/Zod để validate độ dài password, định dạng email ngay tại trình duyệt. Tích hợp hiển thị loading spinner khi gọi API và toast message báo lỗi nếu sai mật khẩu.
