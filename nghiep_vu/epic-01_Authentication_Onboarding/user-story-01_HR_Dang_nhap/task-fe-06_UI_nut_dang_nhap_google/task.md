# task-fe-06_UI_nut_dang_nhap_google

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-06 UI nut dang nhap google.

## Mô tả chức năng chi tiết
Tích hợp Google Identity Services SDK (hoặc React Google Login). Thiết kế nút 'Đăng nhập bằng Google', xử lý luồng popup cấp quyền của Google, nhận credential và gọi API backend để hoàn tất luồng đăng nhập.

## Mục đích
Xây dựng screen/component phục vụ US-01 - HR đăng nhập, tập trung vào hành vi người dùng và trạng thái UI.

## Screen/Component
- Component chính: Google Button.
