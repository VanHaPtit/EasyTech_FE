# task-fe-03_UI_man_hinh_cho_duyet

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-03 UI man hinh cho duyet.

## Mô tả chức năng chi tiết
Thiết kế màn hình 'Pending Approval' thân thiện, ngăn chặn người dùng PENDING truy cập các module khác của hệ thống. Hiển thị rõ thông điệp 'Tài khoản đang chờ Admin kiểm duyệt' kèm nút Liên hệ hỗ trợ.
