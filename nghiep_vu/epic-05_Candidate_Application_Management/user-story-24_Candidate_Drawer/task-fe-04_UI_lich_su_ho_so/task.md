# task-fe-04_UI_lich_su_ho_so

## Mục đích
Task này dùng để xử lý nghiệp vụ liên quan đến chức năng task-fe-04 UI lich su ho so.
...
## Mục đích
Xây dựng screen/component phục vụ US-24 - Candidate Drawer, tập trung vào hành vi người dùng và trạng thái UI.

## Screen/Component
- Component chính: Timeline.
