# Task FE: Loading States

## Mục đích
Xác định phạm vi frontend cho task 'Loading States' trong US-22 Kanban Board, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
## Screen/Component
- Component chính: Loading States.
