# Task FE: CandidatesList

## Mục đích
Xác định phạm vi frontend cho task 'CandidatesList' trong US-23 List View, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
## Screen/Component
- Component chính: CandidatesList.
