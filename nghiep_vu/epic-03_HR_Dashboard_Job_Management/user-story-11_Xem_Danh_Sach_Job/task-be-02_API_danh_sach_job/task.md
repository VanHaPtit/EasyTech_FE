# task-be-02_API_danh_sach_job

## Mục đích
Xác định phạm vi backend cho task 'API danh sach job' trong US-11 Xem Danh Sach Job, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
## Response
- Thành công: BaseResponse(status = 1, message, data); Danh sách job thuộc company hiện tại.
