# Task FE: Redirect Real ID

## Mục đích
Xác định phạm vi frontend cho task 'Redirect Real ID' trong US-12 Tao Job AI JD, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
## Screen/Component
- Component chính: Redirect Real ID.
