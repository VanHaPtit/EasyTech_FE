...
## Mục đích
Xác định phạm vi backend cho task 'API Chart' trong US-10 Dashboard Tong Quan, làm rõ task dùng để làm gì và liên kết với luồng nghiệp vụ tương ứng.
...
## Response
- Thành công: BaseResponse(status = 1, message, data); Dữ liệu biểu đồ theo kỳ.
