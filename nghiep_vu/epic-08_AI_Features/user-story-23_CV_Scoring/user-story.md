...
- **Story:** Là một người dùng, tôi muốn thực hiện `CV Scoring`, để hoàn thành quy trình nghiệp vụ hệ thống.
- **Story Points:** 3

## 2. ACCEPTANCE CRITERIA (Tiêu Chí Nghiệm Thu)
- **Scenario 1:** Thực hiện thành công
  - **GIVEN** hệ thống hoạt động bình thường.
  - **WHEN** người dùng thao tác chức năng `CV Scoring`.
  - **THEN** hệ thống xử lý thành công, lưu thông tin và hiển thị kết quả.

## 3. OUT OF SCOPE (Ngoài Phạm Vi)
- [x] KHÔNG xử lý các tính năng nằm ngoài phạm vi mô tả của `CV Scoring`.
