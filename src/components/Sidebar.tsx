    ...
    <aside className="w-64 border-r border-slate-200 bg-white flex flex-col h-screen fixed left-0 top-0 z-20">
      ...
      <div className="px-4 py-2 border-t border-slate-100">
        <a 
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-[14px] font-bold text-slate-700 bg-slate-50 hover:bg-slate-100 transition-colors border border-slate-200 hover:border-slate-300"
        >
          <Globe2 className="w-5 h-5 text-emerald-600" />
          <span>Xem Site Tuyển Dụng</span>
        </a>
      </div>
